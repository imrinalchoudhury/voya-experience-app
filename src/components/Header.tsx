        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 h-20 flex items-center justify-between">
          <div className="flex items-center gap-12">
            <div className="flex items-center gap-1">
              <span className="font-montserrat font-light text-xl md:text-2xl tracking-[0.3em]">VOYA</span>
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <button
              ...
              className="hidden md:flex items-center gap-2 px-6 py-2.5 bg-transparent border border-voya-gold text-voya-gold font-montserrat text-sm tracking-wider hover:bg-voya-gold/10 transition-colors"
            >
              <Plus size={16} />
              {buttonText}
            </button>
            ...
            {onViewChange && (
              <button
                ...
                className="md:hidden text-voya-gold text-2xl"
              >
                <Menu size={24} />
              </button>
            )}
